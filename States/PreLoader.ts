module MINILD50
{
    export class PreloaderState extends Phaser.State
    {
        ...
        preload()
        {
            ...
            //Loading Buildings
            for (var i = 1; i <= 3; i++) this.load.image('graphics-Level-BuildingParts-Roof128-' + i, 'Content/Graphics/Level/BuildingParts/Roof128-' + i + '.jpg');
            for (var i = 1; i <= 3; i++) this.load.image('graphics-Level-BuildingParts-Roof256-' + i, 'Content/Graphics/Level/BuildingParts/Roof256-' + i + '.jpg');
            for (var i = 1; i <= 2; i++) this.load.image('graphics-Level-BuildingParts-Roof512-' + i, 'Content/Graphics/Level/BuildingParts/Roof512-' + i + '.jpg');
